...
time_slots = [
    ...
    (1,16), (1,17), (1,18), (1,19), (1,20), (1, 21), (1, 22),(1, 23), (2,0), (2,1),
    (2,9), (2,18), (2,20), (2,21), (3,0),
    (3,9), (3,18), (3,20), (3,21),
...
def is_to_late_for_sports(partial_assignment, coef, time_From, time_To):
    sports_not_in_time = 0
    for t_s in partial_assignment:
        this_time_slot = partial_assignment[t_s]

        if this_time_slot == 'Sports' and (t_s[1] > time_To or t_s[1] < time_From):
...
def game_addictivity(partial_assignment, game_addictivity_period,  coef): #1 hr usually only increases wish to play on
    ...
    for t_s in partial_assignment:
        ...
        if (gaming_hrs_in_a_row <= game_addictivity_period):
            ...
            satisfaction -= (gaming_hrs_in_a_row - game_addictivity_period) * coef/game_addictivity_period * 2 # from 0 down to - inf
...
playing(partial_assignment, optimal_time=enought_time_for_sport, undesirable_time=really_enoght_time_for_games, coef=gaming_satisfaction) + \
...
is_to_late_for_sports(partial_assignment, coef=sports_not_in_time_happines_withdraw, time_From=sport_time_from, time_To=sport_time_to) + \
game_addictivity(partial_assignment, game_addictivity_period=3, coef=gaming_satisfaction)  #made to show how it is difficult to stop after single hour
